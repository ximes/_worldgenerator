...
describe ZonesController do
  ...
  describe "GET show" do
    it "assigns the requested zone as @zone" do
      zone = Zone.create! valid_attributes
      get :show, {:id => zone.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested zone as @zone" do
      zone = Zone.create! valid_attributes
      get :edit, {:id => zone.to_param}, valid_session
      assigns(:zone).should eq(zone)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Zone" do
        expect {
          post :create, {:zone => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved zone as @zone" do
        ...
        post :create, {:zone => { "visited" => "invalid value" }}, valid_session
        assigns(:zone).should be_a_new(Zone)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested zone" do
        ...
        Zone.any_instance.should_receive(:update_attributes).with({ "visited" => "false" })
        put :update, {:id => zone.to_param, :zone => { "visited" => "false" }}, valid_session
      end

      it "assigns the requested zone as @zone" do
        zone = Zone.create! valid_attributes
        put :update, {:id => zone.to_param, :zone => valid_attributes}, valid_session
        assigns(:zone).should eq(zone)
      end
    ...
    describe "with invalid params" do
      it "assigns the zone as @zone" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Zone.any_instance.stub(:save).and_return(false)
        put :update, {:id => zone.to_param, :zone => { "visited" => "invalid value" }}, valid_session
        assigns(:zone).should eq(zone)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested zone" do
      zone = Zone.create! valid_attributes
      expect {
        delete :destroy, {:id => zone.to_param}, valid_session
      }.to change(Zone, :count).by(-1)
    end
